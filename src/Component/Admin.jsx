        ...
        <div className="col-md-4">
          <div className="card shadow-sm h-100">
            <div className="card-body" style={{ maxWidth: '600px', backgroundColor: '#d293d2' }}>
              ...
              <button className="btn btn-outline-success w-100">ViewSellers</button>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-4">
          <div className="card shadow-sm h-100">
            <div className="card-body"style={{ maxWidth: '600px', backgroundColor: '#d29393' }}>
              ...
              <button className="btn btn-outline-danger w-100">ViewBuyers</button>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-4">
          <div className="card shadow-sm h-100">
            <div className="card-body"style={{ maxWidth: '600px', backgroundColor: '#d293d2' }}>
              ...
              <button className="btn btn-outline-danger w-100">SearchUsers</button>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-4">
          <div className="card shadow-sm h-100">
            <div className="card-body" style={{ maxWidth: '600px', backgroundColor: '#a393d2' }}>
              ...
              <button className="btn btn-outline-primary w-100">DeleteUser</button>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-4">
          <div className="card shadow-sm h-100">
            <div className="card-body" style={{ maxWidth: '600px', backgroundColor: '#d293d2' }}>
              ...
              <button className="btn btn-outline-primary w-100">AddCategory</button>
            </div>
          </div>
        </div>
